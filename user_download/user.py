...
def getUserVideos(url):
    ...
    # videos = [
    #     "https://v.douyin.com/JdkyMyM/",
    #     "https://v.douyin.com/JdkAoux/",
    #     "https://v.douyin.com/JdrGMNx/"
    # ]
    # return  videos
...
def getUserMedia(user_id, dytk, url):
    ...
    while True:
        ...
        res = requests.get(user_video_url, headers=headers,
                           params=user_video_params,timeout=60)
...
if __name__ == '__main__':
    ...
    videos = getUserVideos("https://v.douyin.com/JdkUEBu/")
